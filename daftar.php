...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="glass-panel rounded-3xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all mt-8 mb-8">
        ...
        <div class="px-8 pt-10 pb-4 text-center">
            ...
            <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight mb-2">Buat Akun</h1>
            <p class="text-gray-500 font-medium">Daftar sekarang untuk mulai memesan di GOWAR</p>
        </div>

        <!-- Form Section -->
        <div class="px-8 pb-10">
            <form action="actions/proses_daftar.php" method="POST" class="space-y-4">
                
                <div>
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-1" for="nama_lengkap">
                        Nama Lengkap
                    </label>
                    <div class="relative group">
                        ...
                        <input class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:outline-none focus:border-wartan-500 transition-all duration-300 font-medium placeholder-gray-400" 
                               type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Masukkan nama lengkap Anda" required autocomplete="off">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-900 focus:bg-white focus:outline-none focus:border-wartan-500 transition-all duration-300 font-medium placeholder-gray-400" 
                               type="text" id="username" name="username" placeholder="Buat username" required autocomplete="off">
                    </div>
                </div>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600 mb-4 font-medium">Sudah punya akun? <a href="login.php" class="text-wartan-600 font-bold hover:text-wartan-700 hover:underline transition-colors">Masuk di sini</a></p>
                    <a href="index.php" class="inline-flex items-center justify-center gap-2 text-sm font-semibold text-gray-500 hover:text-wartan-600 transition-colors w-full py-3 rounded-xl hover:bg-gray-50 border border-transparent hover:border-gray-200">
